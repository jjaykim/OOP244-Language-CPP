...
namespace sdds
{
  ...
  {
  public:
    WalkinPatient(int ticketNumber = 0, bool fileIO = false) : Patient(ticketNumber, fileIO) {}
...
int main()
{
  ...
  cin >> *p;
  p->setArrivalTime();
  cout << "Sections 1 and 2 should match: " << endl
       << endl;
  ...
  cout << "2- The output should be :" << endl
       ...
       << endl;
  p->fileIO(true);
  cout << "1- Your comma separated ouput: " << endl
       << *p << endl;
  cout << "2- comma separated ouput should be: " << endl
       << "W,John Doe,123123123,24,12:34" << endl
       << endl;
  cout << "Enter the following: " << endl;
